...
export { default as ChangeCharacterModal } from './ChangeCharacterModal';
...
export { default as StartToPlayNowModal } from './StartToPlayNowModal';
export { default as StorySettingsModal } from './StorySettingsModal';
