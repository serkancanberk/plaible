...
describe('Routing Configuration', () => {
  it('renders StoryRunnerPage for /app/play/run/:storySlug/:characterSlug route', () => {
    render(
      <BrowserRouter>
        <Routes>
          <Route path="/app/play/run/:storySlug/:characterSlug" element={
            <div data-testid="app-grid-layout">
              <div data-testid="story-runner-page">StoryRunnerPage</div>
            </div>
          } />
        </Routes>
      </BrowserRouter>
    ...
    window.history.pushState({}, '', '/app/play/run/test-story/test-character');
  ...
  it('renders PlayOnboardPage for /app/play/onboard/:storySlug/:characterSlug route', () => {
    render(
      <BrowserRouter>
        <Routes>
          <Route path="/app/play/onboard/:storySlug/:characterSlug" element={
            <div data-testid="app-grid-layout">
              <div data-testid="play-onboard-page">PlayOnboardPage</div>
            </div>
          } />
        </Routes>
      </BrowserRouter>
    ...
    // Navigate to the route
    window.history.pushState({}, '', '/app/play/onboard/test-story/test-character');
      ...
      <BrowserRouter>
        <Routes>
          <Route path="/app" element={
            <div data-testid="app-grid-layout">
              <div data-testid="stories-feed-page">StoriesFeedPage</div>
            </div>
          } />
        </Routes>
      </BrowserRouter>
