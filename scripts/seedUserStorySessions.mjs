      ...
      const mockSessions = [
        {
          ...
          systemPrompt: `You are an AI storyteller for "${sampleStory.title}" by ${sampleStory.authorName}. Stay true to the original author's tone and style. Keep the story in its original time period. Your role is to guide the user through this classic tale while maintaining the authentic voice and setting.`,
          status: "active",
          currentChapter: 1,
          chaptersGenerated: 0,
          userPreferences: {
        ...
        },
        {
          ...
          toneStyleId: "horror",
          timeFlavorId: "today",
          systemPrompt: `You are an AI storyteller for "${sampleStory.title}" by ${sampleStory.authorName}. Add suspense, fear, and supernatural elements to create a horror experience. Adapt the story to modern times with current technology and culture. Your role is to create a chilling, contemporary version of this classic tale.`,
          status: "active",
          currentChapter: 3,
          chaptersGenerated: 2,
          userPreferences: {
        ...
        },
        {
          ...
          systemPrompt: `You are an AI storyteller for "${sampleStory.title}" by ${sampleStory.authorName}. Focus on relationships, love, and emotional connections. Set the story in a romanticized past with vintage charm. Your role is to weave a romantic narrative that emphasizes the emotional depth and relationships in this timeless story.`,
          status: "finished",
          currentChapter: 5,
          chaptersGenerated: 5,
          userPreferences: {
